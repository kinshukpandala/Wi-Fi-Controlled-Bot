...
This repository contains the code and resources for a **Wi-Fi Controlled Bot** built using the **ESP8266 microcontroller** and the **L298N motor driver**. The project was developed as part of our engineering coursework for **(DSN2098) Project Exhibition-I**.
